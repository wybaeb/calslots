...
# Копируем скрипт на рабочий стол
echo "📂 Создаю ярлык на рабочем столе..."
cp show_slots.sh "$SHORTCUT_PATH"
...
if [ -f "$SHORTCUT_PATH" ]; then
    ...
    echo "   Ярлык автоматически найдет проект в стандартных местах:"
    echo "   • $HOME/Sites/calslots"
    echo "   • $HOME/Projects/calslots"  
    echo "   • $HOME/Documents/calslots"
    echo "   • $HOME/calslots"
else
